...
<style>
/* CSS untuk tampilan mobile tabel absensi */
@media (max-width: 767px) {
  /* Untuk tabel rekapitulasi absensi per kelas - versi mobile */
  ...
  .table-mobile-responsive tbody tr td:last-child {
    border-bottom: 0;
  }

  /* Card styling untuk tampilan mobile */
  .mobile-card {
    margin-bottom: 1rem;
    border: 1px solid #dee2e6;
    border-radius: 0.25rem;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Data sebenarnya dari controller dengan safety check
