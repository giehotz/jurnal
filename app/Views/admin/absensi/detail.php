        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?= base_url('admin/absensi?start_date=' . $startDate . '&end_date=' . $endDate . '&rombel_id=' . $rombel['id']) ?>" class="btn btn-secondary btn-sm">
                        ...
                        <?php if (!empty($detailAbsensi)): ?>
                            <?php $no = 1; foreach ($detailAbsensi as $d): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('admin/absensi/edit/' . $d['id']) ?>" class="btn btn-warning btn-sm" title="Edit">
